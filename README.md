...
2. Browse and navigate to the content folder. It should be in the steamapps folder where steam is installed. If one isn't present, you can create it yourself next to the common folder.
