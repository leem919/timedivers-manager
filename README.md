...
1. Select a version and download "using Steam Console".
2. Browse and navigate to the content folder. It should be in the steamapps folder where steam is installed. If one isn't present, you can create it yourself in the same folder as the common folder.
